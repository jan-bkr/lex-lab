  ...
  // ── 1. Harvey AI vs. Luminance ─────────────────────────────────────────────
  {
    ...
    toolA: {
      ...
      scores: {
        ...
        ux: 8,
        preis: 4,
        total: calcScore({ praxisreife: 9, datenschutz: 6, dach: 7, ux: 8, preis: 4 }),
      },
      strengths: [
      ...
      weaknesses: [
        'US-Unternehmen — kein EU-Serverstandort by default',
    ...
    toolB: {
      ...
      scores: {
        ...
        ux: 7,
        preis: 3,
        total: calcScore({ praxisreife: 8, datenschutz: 7, dach: 7, ux: 7, preis: 3 }),
      },
      strengths: [
  ...
  // ── 2. Microsoft 365 Copilot vs. Harvey AI ──────────────────────────────────
  {
    ...
    toolB: {
      ...
      weaknesses: [
        ...
        'Keine Office-Integration — separater Workflow nötig',
        'US-Datenschutz: kein EU-Serverstandort by default',
      ],
    },
    whenA: [
